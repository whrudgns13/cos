    ...
    function search(){
        ...
        AxiosApiService.userseachList(searchType,keyword)
                .then( res => {
                    ...
                    users.user.length>0?setResult(false):setResult(true);  
                    setUsers({
                        user : res.data
                    })
                })
        ...
        <>
            <div style={{width:'100%', display:'flex', alignItems:'center',justifyContent:'space-between'}}>
                ...
                <h1>고객목록</h1>
                    ...
                    <select name="searchType" onChange={onSearchType}>
                    ...
                    <input type="text" placeholder="유저 검색" onChange={onChangeSearch}></input>
